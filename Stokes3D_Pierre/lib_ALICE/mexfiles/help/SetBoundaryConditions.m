...
%
%B2=SetBoundaryConditions(MatrixID,I,B) does the same to the matrix,
...
%
%B2=SetBoundaryConditions(MatrixID,I,B,G) does the same to the matrix,
%   but returns a copy of the B vector where all the values at the indexes
%   given in I are set to the corresponding values in G. 
%
%   B must be a numeric vector at least as long as the smallest dimension of
%   the matrix. If B is sparse, it must be a column vector.
%
...
%   B=[1 2 3 4 5];
%
%   B2=SetBoundaryConditions(A,[1 5],B)
%
%   B2 =
%       0 2 3 4 0
%
