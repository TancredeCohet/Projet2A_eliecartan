...
%-------------------------------------------------------------------------
%           On utilise la formulation variationelle du problème ce qui
%           revient à resoudre le système linéaire M * B = C * U
%
...
%                            / 
%                            O
%           Pour claculer la matrice C on réalise une boucle for en
%           calculant sur chaque triangle les contributions à la matrice C
%--------------------------------------------------------------------------
 ...
 grad_elem_ref = [-1 1 0;            %gradient de phi1, phi2, phi3 sur le triangle de référence
                  -1 0 1];
 ...
 for k = 1:nt
    ...
    grad_elem = Jk' * grad_elem_ref;   %Calcule le gradient dans triangle a partir triangle de reference
