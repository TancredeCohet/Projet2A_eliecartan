...
%
%    Calcul du champ magn̩tique sur un maillage 2D donn̩e
%%-------------------------------------------------------------------------
function [B_X,B_Y] = champ_magnetique_fct(vz,tz,L,P,taille_aimant);

%   v liste des cordonn̩es des neuds
...
%--------------------------------------------------------------------------
%reconstituion de la solution avec les noeuds int̩rieurs car la solution
%actuelle ne porte que sur les noeuds int̩rieurs du maillage
%--------------------------------------------------------------------------
close all; 
u = zeros(nn,1);
u(ic2) = sol;
