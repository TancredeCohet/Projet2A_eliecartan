...
\newline
Tout d'abord dans la configuration pour un aimant centré nous observons sur la coupe clairement deux tourbillons symétrique de part et d'autres de l'aimant, ce qui est logique comme la configuration est symetrique selon le même plan de symétrie, ce qui valide le bon placement des données dans la résolution du problème.
\begin{figure}[!h]
\center
...
sur le plan de coupe près de l'aimant un tourbillon centré dans la cuve.
\begin{figure}[!h]
\center
